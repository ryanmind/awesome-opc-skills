...
- [Philosophy](./docs/philosophy.md) - Deep dive into OPC principles
- [Best Practices](./docs/best-practices.md) - Proven patterns for solo developers
- [Contributing](./CONTRIBUTING.md) - How to add your own skills

## 🤝 Contributing

We welcome contributions! Whether it's:

- 🆕 New skills for solo developers
